...
// const fetchMyAPI = useCallback(() => {
  ...
  const Localurl = 'https://epicipprojects.com/epic-wealth-fund' 
      ...
      <div className="accordion__item">
          ...
          <div className="accordion__item">
            ...
            <div className="accordion__item__content block">
              <ul>
                <li><NavLink to="/markets/EpicipWealthFund" className="navlink a a-active-color">Wealth Fund <span className="fa fa-angle-right"></span></NavLink></li>
