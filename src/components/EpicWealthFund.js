...
const VARdata = [
  ...
  //const DONUTCOLORS10 = ['#1A1549','#9DB1DB','#E6EEF6','#C8C8C8','#dcdcdc','#99103B','#B85876','#D296A9','#B85876','#1A1549','#1A1549','#9DB1DB','#E6EEF6','#C8C8C8','#dcdcdc','#99103B','#B85876','#D296A9','#9DB1DB'];

  const DONUTCOLORS10 = ['#1A1549','#9DB1DB','#E6EEF6','#A6A6A6','#DCDCDC','#99103B','#B85876','#D296A9','#D296A9','#9DB1DB','#E6EEF6','#A6A6A6','#DCDCDC','#99103B','#B85876','#D296A9']
  ...
  // const DONUTCOLORS2 = [ "#0095c8","#b7c9d3","#7030a0","#ffc000","#99103b","#99103b","#b7c9d3"];

  // const DONUTCOLORS = [ "#b7c9d3","#7030a0","#00C49F", "#FFBB28", "#FF8042"];

const EpicWealthFundFunction = () => {
...
const summaryButton=()=>{
 ...
 tt();
  ...
  for(let i=0 ; i< Summary.length ;i++){
    // typeof(products[i][j])
    if(Summary[i].heading== "wealth_fund"){
...
const informationButton=()=>{
  ...
  var keysCMSshareinfo = ["name", "ausdValue","agbpValue","aeurValue","busdValue","bgbpValue","beurValue","cgbp_value","last_value"]
...
if ($(".accordion__item__header").length > 0) {
  ...
  $(".FundInformation__ButtonLink-sc-1gcw03z-0").on("click", function (event) {
    event.stopImmediatePropagation();
...
function renderCMSshareinfo(shareinfoparam, index){
  ...
  if(index ==3){
   ...
   <tr className="Shares__Row-sc-1brks4f-2 eoQrEv" key={index}>
    ...
    <td className="align-right ISIN-font" >{shareinfoparam.ausdValue}</td>:""}
    {shareinfoparam.agbpValue ?
    <td className="align-right ISIN-font">{shareinfoparam.agbpValue}</td> : ""}
    {shareinfoparam.aeurValue ? 
    <td className="align-right ISIN-font">{shareinfoparam.aeurValue}</td> : ""}
    {shareinfoparam.busdValue ?
    <td className="align-right ISIN-font">{shareinfoparam.busdValue}</td> :""}
    {shareinfoparam.bgbpValue ? 
    <td className="align-right ISIN-font">{shareinfoparam.bgbpValue}</td> :""}
    {shareinfoparam.beurValue ? 
    <td className="align-right ISIN-font">{shareinfoparam.beurValue}</td>:""}
      
      <td className="align-right ISIN-font">{shareinfoparam.cgbp_value}</td>
      <td className="align-right ISIN-font">{shareinfoparam.last_value}</td>
  </tr>
    )
  }else{
  return(
    <tr className="Shares__Row-sc-1brks4f-2 eoQrEv" key={index}>
      ...
      <td className="align-right">{shareinfoparam.agbpValue}</td>
      <td className="align-right">{shareinfoparam.aeurValue}</td>
      <td className="align-right">{shareinfoparam.busdValue}</td>
      <td className="align-right">{shareinfoparam.bgbpValue}</td>
      <td className="align-right">{shareinfoparam.beurValue}</td>
      <td className="align-right">{shareinfoparam.cgbp_value}</td>
      <td className="align-right">{shareinfoparam.last_value}</td>
...
console.log(graphData,'mahesh GGGGGGGGGGG')
var graphDataset =[];
    ...
    <div className="row">
      ...
      <div className="accordion__item">
            ...
            <div className="accordion__item__content">
              <ul>
                {/* <li><NavLink to="/markets/EpiciNfaUcitsFundRoute" className="navlink a">EPIC - NFA Global Bond Fund UI (EPIC)<span className="fa fa-angle-right"></span></NavLink></li> */}
                <li><NavLink to="/markets/EpicNextGenUcitsFundRoute" className="navlink a">EPIC - Next Generation Bond Fund UI (EPIC)<span className="fa fa-angle-right"></span></NavLink></li>
          ...
          <div className="accordion__item">
            ...
            <div className="accordion__item__content block">
              <ul>
                <li><NavLink to="/markets/EpicipWealthFund" className="navlink a a-active-color">EPIC Wealth Fund <span className="fa fa-angle-right"></span></NavLink></li>
                            ...
                            <div class="col">
                                <div>
                                    ...
                                    <div class="DailyPricing__Boxes-sc-62f3gi-0 biswZj">
                                        ...
                                        <div class="DailyPricing__DailyPriceCard-sc-62f3gi-1 coIgZR">
                                            <div class="DailyPricing__DailyPrice-sc-62f3gi-2 gsZde">£{arrPRTUState[7]}</div>
                                            <div class="DailyPricing__DailyPriceName-sc-62f3gi-3 iLShEo">Class X<br/><span className="daily-span">(USD) Shares</span></div>
                                        </div> */}
      ...
      <div class="tab-pane fade" id="eight" role="tabpanel">
        ...
        <PieChart width={330} height={750} margin ={ {top: -60, right: 50, bottom: 5, left: 30} } >
          ...
          <p class="lse_redirect"><a className="display-none" target="_blank" href="transaction-own-share.php">Transaction In Own Share</a></p>
            ...
            <PieChart width={330} height={600} margin ={ {top: -60, right: 50, bottom: 5, left: 30} } >
              <Pie
                data={equititeState}
                cx={80}
                cy={200}
          ...
          <div class="col-md-6 TOPmargin chart-block" id="hide_show_equity_text">
          ...
          <p class="lse_redirect">Fixed Income Breakdown (% NAV)</p>
            ...
            <PieChart width={330} height={750} margin ={ {top: -60, right: 50, bottom: 5, left: 30} } >
              ...
              <Legend margin={ {top:-500,} } className="legend-text" formatter={renderColorfulLegendText} iconSize={15} width={300} height={50} layout='vertical' />
            ...
            <div class="row">
                ...
                <p class="lse_redirect">Cumulative Strategy performance</p>
                    <LineChart
                      ...
                      <p class="lse_redirect1"><span class="span_color"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>&nbsp;&nbsp; EPIC Wealth Fund Class GBP Acc</p>
                      </div>
                ...
                <div className="row remove_margin_multi_asset">
                ...
                <div class="mb-2 row table-wealthMonthly-row">
                    <div class="col-md-12" >
...
export default EpicWealthFundFunction;
