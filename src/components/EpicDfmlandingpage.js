...
<section className="main-box">
  <div className="container">
    ...
    <div class="Section__SectionContent-sc-1iot0f7-2 ">
      <p>The EPIC Discretionary Fund Management Proposition is offered to FCA regulated firms ("Advisers") only, on an "agent-as-client" basis.</p>
...
{/* <h3>Our products</h3><br/> */}
                <p>
                <NavLink to="/markets/RiskEpicDFM" className="navlink a"><b>Risk Managed Decumulation Portfolios</b> <span className="fa fa-angle-right"></span></NavLink><br/><br/>
                <NavLink to="/markets/AIMPortfolioDFM" className="navlink a"><b>AIM Portfolio</b> <span className="fa fa-angle-right"></span></NavLink><br/><br/>
                <NavLink to="/markets/RiskTargetedDFM" className="navlink a"><b>Risk Targeted Portfolios</b> <span className="fa fa-angle-right"></span></NavLink>
