  ...
  <div className="container">
    <div className="row">
      ...
      <div className="accordion__item">
          ...
          <div className="accordion__item">
            <div className="accordion__item__header active"><NavLink to="/markets/Hedge-Funds" className="navlink a active-dis ">Fund of Hedge Funds </NavLink></div>
          </div>
          {/* <div className="accordion__item">
...
<h3>Master Capital Fund Limited</h3><br/>
                <p>
                Master Capital Fund Limited is a Cayman domiciled fund founded in 2004. It is a global, equity-focused, multi-manager fund investing primarily in hedge funds.</p>

                <p>The Fund’s aim is to achieve long term capital appreciation, while protecting capital in down markets, by investing in a diversified portfolio of hedge funds giving exposure to equities.  It is a concentrated and high conviction portfolio of funds managed by well-established managers with long term track records as well as select small, new or niche managers.</p>

                <p>The Fund is an easy vehicle for investing in alternatives and brings enhanced access to hedge fund investing, on favourable terms in institutional classes, including funds that may be hard to access or closed for further investment. It is nimble and able to invest in newer opportunities and start-ups.</p>
...
export default HedgeFundsLanding;
