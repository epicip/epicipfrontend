...
<h3>Our products</h3><br/>
                <p>
                <NavLink to="/markets/EpicipWealthFund" className="navlink a">Wealth Fund <span className="fa fa-angle-right"></span></NavLink><br/>
<NavLink to="/markets/EpicipDiversifiedIncomeFund" className="navlink a">Diversified Income <span className="fa fa-angle-right"></span></NavLink><br/>
<NavLink to="/markets/EpicipMultiAssetFund" className="navlink a">Multi Asset Balanced <span className="fa fa-angle-right"></span></NavLink><br/>
<NavLink to="/markets/EpicipMultiAssetGrowthFund" className="navlink a">Multi Asset Growth <span className="fa fa-angle-right"></span></NavLink><br/>
