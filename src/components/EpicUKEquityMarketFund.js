...
const EpicUKEquityMarketFunction = () => {
...
const literatureButton=()=>{
  ...
  var LiteratureKeys = ["LiteratureNameKey","FileName","LiteratureDate","LiteratureTitle"];
    ...
    for(let i=0 ; i< Literature.length ;i++){
      ...
      if(FundName == "ukequity_market_fund"){
...
const summaryButton=()=>{
  ...
  for(let i=0 ; i< Summary.length ;i++){
    // typeof(products[i][j])
    if(Summary[i].heading== "ukequity_market_fund"){
...
//    for(let i=1 ; i< AssetAllocation.length ;i++){
//     // typeof(products[i][j])
  ...
  <div className="container">
    <div className="row">
      ...
      <div className="accordion__item">
            <div className="accordion__item__header"><NavLink to="/markets/markets/Epic-FixedIncome" className="navlink a ">Fixed Income</NavLink></div>
            ...
            <div className="accordion__item__content block">
              <ul>
                ...
                <li><NavLink to="/markets/EpicAsianCentricGlobalGrowth" className="navlink a">VT EPIC Asian Centric Global Growth Fund <span className="fa fa-angle-right"></span></NavLink></li>
				        {/* <li><NavLink to="/markets/EpicUKEquityMarketFund" className="navlink a a-active-color">VT EPIC UK Equity Market Fund <span className="fa fa-angle-right"></span></NavLink></li> */}
                        ...
                        <div class="row margin-1">
                            <div class="col-md-12">
                                <div>
                                    ...
                                    <p>
                                    Daily Prices can be found at: <a href=" http://www.valu-trac.com/administration-services/clients/garraway/uk-equity-market/" target="_blank"> http://www.valu-trac.com/administration-services/clients/garraway/uk-equity-market/ </a></p>
                                ...
                                <tbody class="table MonthlyPerformance__Body-sc-1n33bhd-3 eLhmcV">
                                    <tr>
                                        <th colspan="99" class="MonthlyPerformance__Title-sc-1n33bhd-1 ekfIgT">
                                            Monthly Performance – Class F Acc.</th>
                                    </tr>
...
export default EpicUKEquityMarketFunction;
