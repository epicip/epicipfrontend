...
const EpicInsightsLandingFunction = () => {
  ...
  const SettingFunction=()=>{
    ...
    // }
        ...
        async function fetchMyService3API(){
          ...
          const localurl ="https://epicipprojects.com/people_api";
        ...
        async function fetchMyServiceAPI(){
          const localurl ="https://epicipprojects.com/key_mapdata";
...
<p><br/>
Our fund managers have the freedom to manage money in line with their distinctive investment strategies, unconstrained by a house view.<br/><br/>
...
export default EpicInsightsLandingFunction;
