    ...
    <div className="row">
      ...
      <div className="accordion__item">
            ...
            <div className="accordion__item__content  block">
              <ul>
                <li><NavLink to="/markets/EpiciNfaUcitsFundRoute" className="navlink a a-active-color">UCITS - NFA Global Bond Fund UI <span className="fa fa-angle-right"></span></NavLink></li>
