...
const EpicAsianCentricGlobalGrowthFund = () => {
...
const literatureButton=()=>{
  ...
  let AdministrationTitle;
  let AdministrationContent;
  ...
  var LiteratureKeys = ["LiteratureNameKey","FileName","LiteratureDate","LiteratureTitle","AdministrationTitle","AdministrationContent","AdministrationLink"];
    ...
    for(let i=0 ; i< Literature.length ;i++){
      ...
      if(FundName == "asian_centric_global_growth_fund"){
        ...
        AdministrationTitle = Literature[i].administration_title;
        AdministrationContent = Literature[i].admin_content
        AdministrationLink = Literature[i].admin_link
        ...
        obj[LiteratureKeys[4]] = AdministrationTitle;
        obj[LiteratureKeys[5]] = AdministrationContent;
        obj[LiteratureKeys[6]] = AdministrationLink;
    ...
    setAdminTitle(AdministrationTitle);
    setAdminContent(AdministrationContent);
    setAdminLink(AdministrationLink)
...
const summaryButton=()=>{
  ...
  for(let i=0 ; i< Summary.length ;i++){
    // typeof(products[i][j])
    if(Summary[i].heading== "asian_centric_global_growth_fund"){
...
// const fetchMyAPI = useCallback(() => {
  ...
  const Localurl = 'https://epicipprojects.com/vtepic-asian-centric-global-growth-fund' 
  ...
  fetch(url).then(resp=> resp.json())
   ...
   console.log("count")
    ...
    setproductsmarketCap(resp.MarketCapBreakdown)
    ...
    setproductsShareClass(resp.Shareclass)
          ...
          <div className="accordion__item">
            ...
            <div className="accordion__item__content block">
              <ul>
                ...
                <li><NavLink to="/markets/EpicAsianCentricGlobalGrowth" className="navlink a a-active-color">Asian Centric Global Growth Fund <span className="fa fa-angle-right"></span></NavLink></li>
    ...
    <div class="tab-content">
                ...
                <div class="row">
                    ...
                    {/* <div role="tabpanel" aria-hidden="false" class="fade tab-pane active show"> */}
                        ...
                        {/* <div class="row margin-1">
                            <div class="col">
                                <div>
                                    <h3 class="Paragraph__Heading-sc-2ra4j2-2 dfMrdv">Daily Prices</h3>
                                    <div class="DailyPricing__Boxes-sc-62f3gi-0 biswZj">
                                        <div class="DailyPricing__DailyPriceCard-sc-62f3gi-1 coIgZR">
                                            <div class="DailyPricing__DailyPrice-sc-62f3gi-2 gsZde">$947.57</div>
                                            <div class="DailyPricing__DailyPriceName-sc-62f3gi-3 iLShEo">Class A(USD) Shares</div>
                                        </div>
                                        <div class="DailyPricing__DailyPriceCard-sc-62f3gi-1 coIgZR">
                                            <div class="DailyPricing__DailyPrice-sc-62f3gi-2 gsZde">£916.75</div>
                                            <div class="DailyPricing__DailyPriceName-sc-62f3gi-3 iLShEo">Class A(GBP Hedged) Shares</div>
                                        </div>
                                        <div class="DailyPricing__DailyPriceCard-sc-62f3gi-1 coIgZR">
                                            <div class="DailyPricing__DailyPrice-sc-62f3gi-2 gsZde">€779.36</div>
                                            <div class="DailyPricing__DailyPriceName-sc-62f3gi-3 iLShEo">Class A(EUR Hedged) Shares</div>
                                        </div>
                                        <div class="DailyPricing__DailyPriceCard-sc-62f3gi-1 coIgZR">
                                            <div class="DailyPricing__DailyPrice-sc-62f3gi-2 gsZde">$1011.52</div>
                                            <div class="DailyPricing__DailyPriceName-sc-62f3gi-3 iLShEo">Class B(USD) Shares</div>
                                        </div>
                                        <div class="DailyPricing__DailyPriceCard-sc-62f3gi-1 coIgZR">
                                            <div class="DailyPricing__DailyPrice-sc-62f3gi-2 gsZde">£755.80</div>
                                            <div class="DailyPricing__DailyPriceName-sc-62f3gi-3 iLShEo">Class B(GBP Hedged) Shares</div>
                                        </div>
                                        <div class="DailyPricing__DailyPriceCard-sc-62f3gi-1 coIgZR">
                                            <div class="DailyPricing__DailyPrice-sc-62f3gi-2 gsZde">€734.72</div>
                                            <div class="DailyPricing__DailyPriceName-sc-62f3gi-3 iLShEo">Class B(EUR Hedged) Shares</div>
                                        </div>
                                        <div class="DailyPricing__DailyPriceCard-sc-62f3gi-1 coIgZR">
                                            <div class="DailyPricing__DailyPrice-sc-62f3gi-2 gsZde">$868.37</div>
                                            <div class="DailyPricing__DailyPriceName-sc-62f3gi-3 iLShEo">Class X(USD) Shares</div>
                                        </div>
                                    </div>
                                    <div class="DailyPricing__SourceWrapper-sc-62f3gi-4 hfRiYK">
                                        <i class="mt-2">Data as at: 05/10/2021</i>
                                        <i class="mt-1">Source: Maples Fund Services (Ireland) Limited</i>
                                    </div>
                                </div>
                            </div>
                        </div> */}
                        <div class="row margin-1">
                            <div class="col-md-12">
                                <div>
                                    ...
                                    <div class="DailyPricing__Boxes-sc-62f3gi-0 biswZj">
                                      <p>
                                    Daily Prices can be found at: <a href="http://www.valu-trac.com/administration-services/clients/garraway/asian-centric-global-growth/" target="_blank">http://www.valu-trac.com/administration-services/clients/garraway/asian-centric-global-growth/ </a></p>
                                        {/* <div class="DailyPricing__DailyPriceCard-sc-62f3gi-1 coIgZR">
        ...
        <div class="row chart-row">
          ...
          <table class="AssetClass__Table-sc-1rmhbx4-3 mt iiGyEE">
            <tbody class="AssetClass__Body-sc-1rmhbx4-4 cyhKrw">
              ...
              {regionBreakdownState.map(renderMarketState)}
                ...
                <div class="mb-2 row">
                    ...
                    <div class="MonthlyPerformance__Wrapper-sc-1n33bhd-0 cHAvbZ">
                        <table class=" MonthlyPerformance__Table-sc-1n33bhd-2 bDbyAW">
                                <tbody class="table MonthlyPerformance__Body-sc-1n33bhd-3 eLhmcV">
                                    <tr>
                                        <th colspan="99" class="MonthlyPerformance__Title-sc-1n33bhd-1 ekfIgT">
                                            Monthly Performance – GFT Class R Inc</th>
                                    </tr>
                            ...
                            {/* <table class="table-bordered MonthlyPerformance__Table-sc-1n33bhd-2 bDbyAW">
                                <tbody class="MonthlyPerformance__Body-sc-1n33bhd-3 eLhmcV">
                                    <tr>
                                        <th colspan="99" class="MonthlyPerformance__Title-sc-1n33bhd-1 ekfIgT">
      ...
      <br/></p>
                ...
                {/* <div class="FundTabs__SourceWrapper-ttsyio-0 gCxwto">
                    <i class="mt-2">Monthly data as at: 31/08/2021. All information also available to download <a target="blank" href="https://garrawaystorage.blob.core.windows.net/garraway-files/Factsheets/garraway_financial_trends.pdf">here</a></i></div> */}
                    </div>            
          </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div role="tabpanel" aria-hidden="false" class="fade tab-pane active show">
                ...
                {/* <div class="FundTabs__SourceWrapper-ttsyio-0 gCxwto">
                    <i class="mt-2">Monthly data as at: 31/08/2021. All information also available to download <a target="blank" href="https://garrawaystorage.blob.core.windows.net/garraway-files/Factsheets/garraway_financial_trends.pdf">here</a></i>
                </div> */}
            </div>
...
export default EpicAsianCentricGlobalGrowthFund;
