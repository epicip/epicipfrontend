          ...
          <div className="accordion__item">
            ...
            <div className="accordion__item__content block">
              <ul>
                ...
                <li><NavLink to="/markets/EpicAsianCentricGlobalGrowth" className="navlink a a-active-color">VT EPIC Asian Centric Global Growth Fund <span className="fa fa-angle-right"></span></NavLink></li>
