          ...
          <div className="accordion__item">
            ...
            <div className="accordion__item__content block">
              <ul>
                ...
                <li><NavLink to="/markets/EpicipMultiAssetGrowthFund" className="navlink a a-active-color">Multi Asset Growth <span className="fa fa-angle-right"></span></NavLink></li>
              </ul>
            </div>
          </div>
          <div className="accordion__item">
