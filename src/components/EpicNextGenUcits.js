...
if ($(".accordion__item__header").length > 0) {
  ...
  function renderDailyPrices(DailyPrice, index){
    if(DailyPrice.Price !== 0 && DailyPrice.fundName == "Stratton Street UCITS-Next Gen.Gl.Bd.Fd."){
    return(
      ...
      <div className="accordion__item">
            ...
            <div className="accordion__item__content  block">
              <ul>
                ...
                <li><NavLink to="/markets/EpicNextGenUcitsFundRoute" className="navlink a a-active-color">UCITS - Next Generation Bond Fund UI<span className="fa fa-angle-right"></span></NavLink></li>
                { StateSession !== 0 ?
