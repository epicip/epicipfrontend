...
const [NewsContentState,setNewsContentState]= useState([]);
const [NewsHeadingState,setNewsHeadingState]= useState([]);
...
var news_content;
var news_content_id;
var news_link_id = slug; 
var news_heading;

    for(let i=0 ; i< NewsData.length ;i++){
        let obj={};

          news_content_id= NewsData[i].id;
        
             if(news_link_id == news_content_id){
                news_content = NewsData[i].content;
                news_heading = NewsData[i].heading
            } 
        }
setNewsContentState(news_content)
setNewsHeadingState(news_heading)
}
...
// const fetchMyAPI = useCallback(() => {
  ...
  // const url = 'https://epicipprojects.com/api/news_data' 
    ...
    return(
            ...
            <div class="col-sm-12">
                <p class="pdf_download">
                    <a href={window.location.origin+"/storage/literature-file/1637325497_KIID-Garraway-Financial-Trends-Class-A-CHF.pdf"}>{data.date}<br/>
...
function renderLiteratureData(data, index){
  return(
              ...
              <div class="col-sm-6">
					      <p class="pdf_download"><a href={data.FileName}>{data.LiteratureTitle}<br/><span class="date">{data.LiteratureDate}</span></a></p>
				      </div>
  )
}
...
<section className="main-box">
  <div className="container">
    <div className="row">
      ...
      <ul className="nav nav-tabs latest_news_button" role="tablist">
        <li className="nav-item nav-item-tabs latest_news_button" id="latest_news_button"> <a class="nav-link active" data-toggle="tab" id="summaryButton" onClick={latestNews} href="#nine" role="tab">Latest News</a> </li>
      </ul>
    
    
    <div class="Section__SectionContent-sc-1iot0f7-2 cIrppL">
...
export default DailyUpdateDataFunction;
