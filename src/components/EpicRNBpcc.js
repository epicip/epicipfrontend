...
<li><NavLink to="/markets/EpicNextGenPCC" className="navlink a ">PCC - Next Generation Bond Fund<span className="fa fa-angle-right"></span></NavLink></li>
  ...
  return(
  <li><a href="" className="navlink a ">PCC - Next Generation Bond Fund<span className="fa fa-angle-right"></span></a></li>
  )
}
}
      ...
      <div className="accordion__item">
            ...
            <div className="accordion__item__content block">
              <ul>
                ...
                { StateSession !== 0 ?
                <li><NavLink to="/markets/EpicRNBpcc" className="navlink a a-active-color" >PCC - Renminbi Bond Fund<span className="fa fa-angle-right"></span></NavLink></li>
                :
                <li><a href={window.location.origin+"/login_user"} className="navlink a a-active-color">PCC - Renminbi Bond Fund<span className="fa fa-angle-right"></span></a></li>
                }
              </ul>
            </div>
          </div>
