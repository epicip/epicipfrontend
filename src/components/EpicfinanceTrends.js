        ...
        <div className="accordion__item">
            ...
            <div className="accordion__item__content">
              <ul>
                ...
                <li><NavLink to="/markets/EpicNextGenUcitsFundRoute" className="navlink a">UCITS - Next Generation Global Fund UI<span className="fa fa-angle-right"></span></NavLink></li>
          ...
          <div className="accordion__item">
            ...
            <div className="accordion__item__content block">
              <ul>
                <li><NavLink to="/markets/EpicfinanceTrends" className="navlink a a-active-color">Financial Trends <span className="fa fa-angle-right"></span></NavLink></li>
              </ul>
            </div>
          </div>
          <div className="accordion__item">
