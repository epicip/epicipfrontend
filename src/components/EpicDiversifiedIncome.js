          ...
          <div className="accordion__item">
            ...
            <div className="accordion__item__content block">
              <ul>
                ...
                <li><NavLink to="/markets/EpicipDiversifiedIncomeFund" className="navlink a a-active-color">Diversified Income <span className="fa fa-angle-right"></span></NavLink></li>
