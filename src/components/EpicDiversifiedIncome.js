...
const literatureButton=()=>{
  ...
  var LiteratureKeys = ["LiteratureNameKey","FileName","LiteratureDate","LiteratureTitle"];
    ...
    for(let i=0 ; i< Literature.length ;i++){
      ...
      if(FundName == "diversified_income_fund"){
...
const summaryButton=()=>{
  ...
  for(let i=0 ; i< Summary.length ;i++){
    // typeof(products[i][j])
    if(Summary[i].heading== "diversified_income_fund"){
          ...
          <div className="accordion__item">
            ...
            <div className="accordion__item__content block">
              <ul>
                ...
                <li><NavLink to="/markets/EpicipDiversifiedIncomeFund" className="navlink a a-active-color">VT EPIC Diversified Income <span className="fa fa-angle-right"></span></NavLink></li>
                            ...
                            <div class="col">
                                ...
                                <h3 class="Paragraph__Heading-sc-2ra4j2-2 ">Daily Prices</h3>
                                    <div class="DailyPricing__Boxes-sc-62f3gi-0 biswZj">
                                        ...
                                        <p>
                                    Daily Prices can be found at: <a href="https://www.valu-trac.com/administration-services/clients/garraway/diversified-income/" target="_blank">https://www.valu-trac.com/administration-services/clients/garraway/diversified-income/</a></p>
...
export default EpicDiversifiedFunction;
