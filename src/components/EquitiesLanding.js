...
<h3>Our products</h3><br/>
                ...
                <NavLink to="/markets/EpicAsianCentricGlobalGrowth" className="navlink a">Asian Centric Global Growth Fund <span className="fa fa-angle-right"></span></NavLink><br/>
				<NavLink to="/markets/EpicUKEquityMarketFund" className="navlink a">UK Equity Market Fund <span className="fa fa-angle-right"></span></NavLink><br/>
                </p>
