  ...
  const LoopingFunction=()=>{
    ...
    var allKeys = ["KeyName"];
        ...
        for(let j=0 ; j< KeyMap.length ;j++){
          ...
          for(let i=0 ; i< MarketContent.length ;i++){
            ...
            if(MarketContent[i].id == KeyMap[j].allpages_id){
              ...
              var MarketText = MarketContent[3].content
      ...
      //  }
        ...
        KeyName2 = uniqueArray[3];
        KeyLink2 = ArrKeyLink[3];
        
        KeyName3 = uniqueArray[4];
        KeyLink3 = ArrKeyLink[4];
  
        KeyName4 = uniqueArray[0];
        KeyLink4 = ArrKeyLink[0];
          ...
          <div className="accordion__item">
            ...
            <div className="accordion__item__content">
              <ul>
                ...
                <li><NavLink to="/market/RiskEpicDFM" className="navlink a ">EPIC MPS Risk Managed Decumulation 5 <span className="fa fa-angle-right"></span></NavLink></li>
...
<p><br/>
We focus on investing in companies with strong sustainable growth potential to which market influences have limited impact.<br/><br/>
Our strategy is to invest in companies that have high-quality characteristics in terms of their business models, financials, competitive advantage and their management. We believe that this will provide resilience during periods of market uncertainty.<br/><br/>
In order to generate superior long-term risk adjusted returns we need to be invested in the right companies and at the right price. With the current continuous multiple expansion, we are mindful that it is more important than ever to stick to this discipline.</p> */}
</div>    
...
<button type="button" id="headerButton" onClick={functionArraySetting} className="btn-primary float-right hidden">Header</button> 
                ...
                <p>
                <NavLink to="/markets/EpicglobalEquity" className="navlink a">EPIC Global Equity Fund <span className="fa fa-angle-right"></span></NavLink><br/>
                <NavLink to="/markets/EpicorientalFocus" className="navlink a">EPIC Oriental Focus Fund <span className="fa fa-angle-right"></span></NavLink><br/>
                <NavLink to="/markets/EpicAsianCentricGlobalGrowth" className="navlink a">VT EPIC Asian Centric Global Growth Fund <span className="fa fa-angle-right"></span></NavLink><br/>
				{/* <NavLink to="/markets/EpicUKEquityMarketFund" className="navlink a">VT EPIC UK Equity Market Fund <span className="fa fa-angle-right"></span></NavLink><br/> */}
                  <NavLink to="/markets/AIMPortfolioDFM" className="navlink a">AIM Portfolio <span className="fa fa-angle-right"></span></NavLink><br/><br/>
                </p>
...
export default EpicEquitiesFunction;
