...
const VARdata = [
  ...
  const renderColorfulLegendText = (value, entry) => {
    const { color } = entry;
    console.log(entry.payload.value,"mahesh 78787878");
...
const EpicMultiAssetBalancedFunction = () => {
...
const summaryButton=()=>{
  ...
  for(let i=0 ; i< Summary.length ;i++){
    // typeof(products[i][j])
    if(Summary[i].heading== "aim_portfolio"){
...
//     console.log(val, "mahesh12121212");
//     console.log("-----------------------------------ValVAL");
//     if(val != ''){
...
var length = AssetAllocation.length;
 ...
 var keysInceptionData21 = ["name", "value"]
  ...
  obj1[keysInceptionData21[0]] = productstop10Holding[1][3];
  let val12 = productstop10Holding[1][4]*100;
  var rounded112 = Math.round(Math.round((val12 + Number.EPSILON) * 100) / 100,1);
  obj1[keysInceptionData21[1]] = rounded112;
  obj2[keysInceptionData21[0]] = productstop10Holding[2][3];
  let val123 = productstop10Holding[2][4]*100;
...
console.log(InceptionDataArray2,"mahesh12345");
...
// const fetchMyAPI = useCallback(() => {
  ...
  const Localurl = 'https://www.epicip.com/vtepic-multi-asset-balanced-fund'
    ...
    //const url = window.location.origin+'/AIM-Portfolio' 
   //const url = 'https://www.epicip.com/AIM-Portfolio' 
   const url = 'http://127.0.0.1:8000/AIM-Portfolio'
  ...
  <div className="container">
    ...
    <div class="tab-content">
            ...
            <div role="tabpanel" aria-hidden="false" class="fade tab-pane active show">
                ...
                <div class="col">
                    ...
                    {/* <div class="col-md-12">
                      <div class="Paragraph__ParagraphContainer-sc-2ra4j2-0 gnBxSc">
                          <div>
                            { PressCoverageState.length>0 ? <div><h3><b>Recent Updates</b></h3></div>  : ""}
      ...
      <div class="tab-pane fade" id="eight" role="tabpanel">
        ...
        <div class="col-md-6 SECmargin chart-block" style={{height: "389px"}}> 
          ...
          <p class="lse_redirect"><a className="display-none" target="_blank" href="transaction-own-share.php">Transaction In Own Share</a></p>
            ...
            <PieChart width={290} height={550} margin ={ {top: -60, right: 50, bottom: 5, left: 20} } >
              <Pie
                data={graphData}
                cx={80}
                cy={200}
        ...
        <div class="DailyPricing__SourceWrapper-sc-62f3gi-4 hfRiYK"><br/>
                     ...
                     All information also available to download <a href={window.location.origin+"/sitepdfs/aim_portfolio.pdf"} target="_blank">here</a>
                      <br/></p>
                  </div>
      </div>
          ...
          <div class="col-sm-12">
            ...
            <div class="row chart-row">
                                ...
                                <tbody class="table MonthlyPerformance__Body-sc-1n33bhd-3 eLhmcV">
                                    <tr>
                                        <th colspan="99" class="MonthlyPerformance__Title-sc-1n33bhd-1 ekfIgT">
                                            Monthly Performance – Class I Acc.</th>
                                    </tr>
                ...
                <div class="DailyPricing__SourceWrapper-sc-62f3gi-4 hfRiYK">
                     <p className="mt-2 i">Monthly data as at: {PRTUDate}.
                      All information also available to download <a href={window.location.origin+"/sitepdfs/aim_portfolio.pdf"} target="_blank" download>here </a> 
                      <br/></p>
                  </div>
            </div>
...
export default EpicMultiAssetBalancedFunction;
